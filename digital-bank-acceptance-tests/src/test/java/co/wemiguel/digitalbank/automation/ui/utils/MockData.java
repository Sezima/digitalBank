...
public class MockData {
    ...
    public Map<String, String> generateRandomNameAndEmail() {
       ...
       // int randomInt = new Random().nextInt(4);
        //tring email = name+randomInt+"@gmail.com";
    ...
    public static void main(String[] args) {
     ...
     //   System.out.println(mockData.generateRandomNameAndEmail().get("name"));
        //System.out.println(mockData.generateRandomNameAndEmail().get("email"));
